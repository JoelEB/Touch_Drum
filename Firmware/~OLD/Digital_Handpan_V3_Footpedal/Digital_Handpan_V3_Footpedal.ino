...
void touchCheck()
{
  ...
  //sensitivity just right. Try adjusting these values to get the best response. 
    ...
    if (touchRead(pinTouch[0]) > 2500)
    {
      ...
      if(octave_index == 1)
        sine1.frequency(note_frequency[scale[scale_index][0]+12]);
      else if(octave_index == -1)
        sine1.frequency(note_frequency[scale[scale_index][0]-12]);
      else if(octave_index == 2)
        sine1.frequency(note_frequency[scale[scale_index][0]+24]);
      else if(octave_index == -2)
        sine1.frequency(note_frequency[scale[scale_index][0]-24]);
      else 
    ...
    if (touchRead(pinTouch[1]) > 2500) 
    {
      if(octave_index == 1)
        sine2.frequency(note_frequency[scale[scale_index][1]+12]);
      else if(octave_index == -1)
        sine2.frequency(note_frequency[scale[scale_index][1]-12]);
      else if(octave_index == 2)
        sine2.frequency(note_frequency[scale[scale_index][1]+24]);
      else if(octave_index == -2)
        sine2.frequency(note_frequency[scale[scale_index][1]-24]);
      else 
    ...
    if (touchRead(pinTouch[2]) > 2500)
    {
      if(octave_index == 1)
        sine3.frequency(note_frequency[scale[scale_index][2]+12]);
      else if(octave_index == -1)
        sine3.frequency(note_frequency[scale[scale_index][2]-12]);
      else if(octave_index == 2)
        sine3.frequency(note_frequency[scale[scale_index][2]+24]);
      else if(octave_index == -2)
        sine3.frequency(note_frequency[scale[scale_index][2]-24]);
      else 
    ...
    if (touchRead(pinTouch[3]) > 2500)
    {
      if(octave_index == 1)
        sine4.frequency(note_frequency[scale[scale_index][3]+12]);
      else if(octave_index == -1)
        sine4.frequency(note_frequency[scale[scale_index][3]-12]);
      else if(octave_index == 2)
        sine4.frequency(note_frequency[scale[scale_index][3]+24]);
      else if(octave_index == -2)
        sine4.frequency(note_frequency[scale[scale_index][3]-24]);
      else 
    ...
    if (touchRead(pinTouch[4]) > 2500) 
    {
      if(octave_index == 1)
        sine5.frequency(note_frequency[scale[scale_index][4]+12]);
      else if(octave_index == -1)
        sine5.frequency(note_frequency[scale[scale_index][4]-12]);
      else if(octave_index == 2)
        sine5.frequency(note_frequency[scale[scale_index][4]+24]);
      else if(octave_index == -2)
        sine5.frequency(note_frequency[scale[scale_index][4]-24]);
      else 
    ...
    if (touchRead(pinTouch[5]) > 2500)
    {
      if(octave_index == 1)
        sine6.frequency(note_frequency[scale[scale_index][5]+12]);
      else if(octave_index == -1)
        sine6.frequency(note_frequency[scale[scale_index][5]-12]);
      else if(octave_index == 2)
        sine6.frequency(note_frequency[scale[scale_index][5]+24]);
      else if(octave_index == -2)
        sine6.frequency(note_frequency[scale[scale_index][5]-24]);
      else 
    ...
    if (touchRead(pinTouch[6]) > 2500)
    {
      if(octave_index == 1)
        sine7.frequency(note_frequency[scale[scale_index][6]+12]);
      else if(octave_index == -1)
        sine7.frequency(note_frequency[scale[scale_index][6]-12]);
      else if(octave_index == 2)
        sine7.frequency(note_frequency[scale[scale_index][6]+24]);
      else if(octave_index == -2)
        sine7.frequency(note_frequency[scale[scale_index][6]-24]);
      else 
    ...
    {
      if(octave_index == 1)
        sine8.frequency(note_frequency[scale[scale_index][7]+12]);
      else if(octave_index == -1)
        sine8.frequency(note_frequency[scale[scale_index][7]-12]);
      else if(octave_index == 2)
        sine8.frequency(note_frequency[scale[scale_index][7]+24]);
      else if(octave_index == -2)
        sine8.frequency(note_frequency[scale[scale_index][7]-24]);
      else 
