...
//////////DEBOUNCE
//TouchReadBounce button_left = TouchReadBounce(pinTouch[8], 15, touchThreshold[8]);
//TouchReadBounce button_right = TouchReadBounce(pinTouch[9], 15, touchThreshold[9]);
...
int TouchReadBounce() 
{
  ...
  //uint8_t newState = touchRead(pin);
  if (state > threshold) 
  {
