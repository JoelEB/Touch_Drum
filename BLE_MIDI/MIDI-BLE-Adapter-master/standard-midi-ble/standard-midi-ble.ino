...
void setupBLE()
{
	blePeripheral.setLocalName("TOUCH_DRUM"); //local name sometimes used by central
	blePeripheral.setDeviceName("TOUCH_DRUM"); //device name sometimes used by central
